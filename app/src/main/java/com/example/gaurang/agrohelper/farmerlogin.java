...
*/
        ...
        p.show();
        auth.signInWithEmailAndPassword(email1+"@gmail.com",password1).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            @Override
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if(!task.isSuccessful()) {
                    Toast.makeText(farmerlogin.this, "Cannot login", Toast.LENGTH_SHORT).show();
    ...
    public void signup(View view)
    {
        ...
        Intent next=new Intent(this,farmersignup.class);
        startActivity(next);
